...
# #463: PRIMARY repo root (not the current tree's) -- board state
# (board-cache.json, board-comments-seen.json, board-queue.jsonl via
# board-queue.sh) lives once per repo in the main checkout's gitignored
