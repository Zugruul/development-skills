...
echo "== changelog-generate SKILL.md contract (#165, rewired to changelog.py by #404) =="
...
check "changelog-generate SKILL.md wires changelog.py generate (#404)" "changelog.py\" generate" "$CLBODY"
