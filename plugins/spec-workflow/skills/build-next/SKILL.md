...
11. **Decide, don't ask.** In autonomous/auto mode the orchestrator decides itself and does not use AskUserQuestion unless a hard permission denial or an explicit instruction requires human direction — see `auto-review.md` §3-§5 for the merge/review protocol this governs.
